*/
  vì dãy nhập vào là các số từ 1 đến n  cho lên ta chỉ cần có trước tổng các số từ 1 đến n và trừ dần đi qua các bước nhập
  sau khi nhập xong thì tổng đó chính là kết quả bài toán.
*/
